...
class BookingsController extends Controller
{
    ...
    public function updateBookingStatus(Request $request,EmailController $email) {
        ...
        $email = new EmailController;
        $email->bookingAcceptedOrDeclined($booking->id,$mystatus);
        $email->HostAcceptedOrDeclined($booking->id,$mystatus);
        return redirect()->back()->with('message', $booking->status. 'your booking');
