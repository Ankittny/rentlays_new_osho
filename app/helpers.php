 ...
 */
if (!function_exists('phpDefaultTimeZones')) {
...
if (!function_exists('codeToSymbol')) {
...
if (!function_exists('SymbolToCode')) {
...
if(!function_exists('currency_fix')){
...
if(!function_exists('getInboxUnreadCount')){
