        ...
        <div class="container">
            ...
            <section class="slider-area slider ">
                ...
                <div>
                    ...
                    <a onclick="handleClickWithParam({{$itemsType->id}});">
                        <p class="text-12 mb-0 properttypetext"> {{$itemsType->name}} </p>
                    </a>
                </div>
                @endforeach
                @endif
...
<script>
    ...
    function toggleVisibility() {
        ...
        // Toggle the visibility of the input group to act like a dropdown
        if (inputGroup.style.display === 'none' || inputGroup.style.display === '') {
            inputGroup.style.display = 'block'; // Show the input group
        } else {
