            ...
            <div class="container-fluid min-height">
                <div class="col-md-12 mt-5">
                    <div class="main-panel">
                        ...
                        <div class="row justify-content-center mt-5 border rounded-3 mb-5 pt-2 pb-2 bkwhite">
                            <div class="col-md-12 p-4">
                                <form id='profile_update' method='post' action="{{ url('users/profile') }}" onsubmit="return ageValidate();">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mt-3">
                                                <label for="user_phone"> {{ __('Country') }}<span class="text-danger">*</span> </label>
                                                <select class="form-control" name="country">
                                                   @if($country->count() > 0) 
                                                      @foreach($country as $items)
                                                       <option value="{{$items->name}}" {{$items->name == $profile->country ? 'selected' : '' }}>{{$items->name}}</option>
                                                      @endforeach
                                                    @endif
                                                </select>
