            ...
            <div class="col-lg-12 col-12">
                <div class="box box-info">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Designation Form</h3>
                    </div>

                    <form id="edit_designation" method="post" action="{{ url('admin/edit-designation/'.$designation->id) }}" class="form-horizontal" enctype=multipart/form-data>
                        {{ csrf_field() }}
                        <div class="box-body">
                            <div class="form-group row mt-3 name">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="name" class="form-control f-14 validate_field" id="name" placeholder="Name" value="{{ $designation->name }}">
