@extends('admin.template')
	...
	<section class="content-header">
        <h1>Edit Property Type Option</h1> 
    </section>
				...
				<div class="col-lg-9 col-12">
					<div class="box box-info">
						...
						<div class="box-header with-border">
							<h3 class="box-title">Edit Property Option Type Form</h3><span class="email_status" >(<span class="text-green"><i class="fa fa-check" aria-hidden="true"></i>Verified</span>)</span>
						</div>

						<form id="add_property" method="post" action="{{ url('admin/settings/edit-property-type-option/'. $result->id) }}" class="form-horizontal" enctype=multipart/form-data >
							{{ csrf_field() }}
							<div class="box-body">
                                <div class="form-group row mt-3 name">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="name" class="form-control f-14 validate_field" id="name" placeholder="Name" value="{{$result->name}}">
