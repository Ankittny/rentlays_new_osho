					...
					<div class="box box-info">
						...
						<form id="edit_admin" method="post" action="{{ url('admin/edit-admin/' . $result->id) }}" class="form-horizontal" enctype=multipart/form-data >
							...
							<div class="box-body">
                                ...
                                <div class="form-group row mt-3">
                                    <label for="inputEmail3"
                                        class="control-label col-sm-3 fw-bold text-md-end mb-2 mb-md-0">Area Pin Code </label>
                                    <div class="col-sm-6">
                                        <input type="number" name="pincode" class="form-control f-14"
                                            id="pincode"
                                            placeholder="Pincode" value="{{ $result->pincode }}">
