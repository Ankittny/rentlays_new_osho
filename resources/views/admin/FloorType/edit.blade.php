				...
				<div class="col-lg-9 col-12">
					<div class="box box-info">
						...
						<div class="box-header with-border">
							<h3 class="box-title">Edit Floor Type Form</h3><span class="email_status" >(<span class="text-green"><i class="fa fa-check" aria-hidden="true"></i>Verified</span>)</span>
						</div>

						<form id="edit_space" method="post" action="{{ url('admin/settings/edit-floor-type/' . $result->id) }}" class="form-horizontal" enctype=multipart/form-data >
							{{ csrf_field() }}
							<div class="box-body">
                                <div class="form-group row mt-3 name">
                                    <label for="inputEmail3" class="control-label col-sm-3 fw-bold text-md-end mb-2 mb-md-0">Enter Floor Number 
