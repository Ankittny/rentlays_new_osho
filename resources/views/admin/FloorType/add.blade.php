				...
				<div class="col-lg-9 col-12">
					<div class="box box-info">
						...
						<div class="box-header with-border">
							<h3 class="box-title">Add Floor Type Form</h3><span class="email_status" >(<span class="text-green"><i class="fa fa-check" aria-hidden="true"></i>Verified</span>)</span>
						</div>

						<form id="add_space" method="post" action="{{ url('admin/settings/add-floor-type') }}" class="form-horizontal" enctype=multipart/form-data >
							{{ csrf_field() }}
							<div class="box-body">
