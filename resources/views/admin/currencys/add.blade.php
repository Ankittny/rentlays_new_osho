				...
				<div class="col-lg-9 col-12">
					<div class="box box-info">
						...
						<div class="box-header with-border">
							<h3 class="box-title">Add Currency Form</h3><span class="email_status" >(<span class="text-green"><i class="fa fa-check" aria-hidden="true"></i>Verified</span>)</span>
						</div>

						<form id="add_currency" method="post" action="{{ url('admin/settings/add-currency') }}" class="form-horizontal" >
							{{ csrf_field() }}
							<div class="box-body">
                                ...
                                <div class="form-group row mt-3 code">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="code" class="form-control f-14" id="code" placeholder="Code">
                                ...
                                <div class="form-group row mt-3 rate">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="rate" class="form-control f-14" id="rate" placeholder="Rate">
