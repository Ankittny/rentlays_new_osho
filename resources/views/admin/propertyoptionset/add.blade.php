@extends('admin.template')
    ...
    <section class="content-header">
        <h1>Add Property Type Option Set</h1>
    </section>
			...
			<div class="row">
				...
				<div class="col-lg-9 col-12">
					<div class="box box-info">
						...
						<form id="add_property" method="post" action="{{ url('admin/settings/add-property-type-set-option') }}" class="form-horizontal" enctype=multipart/form-data >
							{{ csrf_field() }}
							<div class="box-body">
                                    ...
                                    <div class="col-sm-6">
                                       ...
                                       @if($PropertyOption->count()>0) 
                                         @foreach($PropertyOption as $ItemsData)
                                           <input name="options[]" type="checkbox" value="{{$ItemsData->id ?? ""}}">{{$ItemsData->name ?? ""}} <br>
                                        @endforeach
                                       @endif
                                    </div>
                                </div>
