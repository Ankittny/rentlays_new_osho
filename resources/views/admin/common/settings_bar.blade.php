<div class="box box-info box_info">
	<div class="panel-body">
		<p class="all_settings mb-0 f-18">Manage Settings</p>
		<ul class="nav navbar-pills nav-tabs nav-stacked no-margin d-flex flex-column f-14" role="tablist">
			...
			@if (Permission::has_permission(Auth::guard('admin')->user()->id, 'google_recaptcha'))
				<li class="{{ (Route::current()->uri() == 'admin/settings/google-recaptcha-api-information')? 'active' : ''  }}">
					<a href="{{ url('admin/settings/google-recaptcha-api-information') }}" data-group="profile">Google reCaptcha</a>
				</li>
			@endif

			@if (Permission::has_permission(Auth::guard('admin')->user()->id, 'manage_banners'))
				<li class="{{ (Route::current()->uri() == 'admin/settings/banners') || (Route::current()->uri() == 'admin/settings/add-banners') || (Route::current()->uri() == 'admin/settings/edit-banners/{id}')? 'active' : ''  }}">
			...
			@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'starting_cities_settings'))
				<li class="{{ (Route::current()->uri() == 'admin/settings/starting-cities') || (Route::current()->uri() == 'admin/settings/add-starting-cities') || (Route::current()->uri() == 'admin/settings/edit-starting-cities/{id}') ? 'active' : ''  }}">
			...
			@endif
			@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'warehouse_type_setting'))
				<li class="{{ (Route::current()->uri() == 'admin/settings/ware-house-type' || Route::current()->uri() == 'admin/settings/add-ware-house-type' || Route::current()->uri() == 'admin/settings/edit-ware-house-type/{id}') ? 'active' : ''  }}">
					<a href="{{ url('admin/settings/ware-house-type') }}" data-group="ware-house-type">Ware House Type</a>
				</li>
			@endif
			@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'accommodates_setting'))
				<li class="{{ (Route::current()->uri() == 'admin/settings/accommodates' || Route::current()->uri() == 'admin/settings/add-accommodates' || Route::current()->uri() == 'admin/settings/edit-accommodates/{id}') ? 'active' : ''  }}">
					<a href="{{ url('admin/settings/accommodates') }}" data-group="ware-house-type">Accommodates</a>
				</li>
			@endif
			@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'property_type_option'))
				<li class="{{ (Route::current()->uri() == 'admin/settings/property-type-option' || Route::current()->uri() == 'admin/settings/add-property-type-option' || Route::current()->uri() == 'admin/settings/edit-property-type-option/{id}') ? 'active' : ''  }}">
					<a href="{{ url('admin/settings/property-type-option') }}" data-group="ware-house-type">Property Type Option</a>
				</li>
			@endif
			@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'property_type_option_set'))
				<li class="{{ (Route::current()->uri() == 'admin/settings/property-type-set-option' || Route::current()->uri() == 'admin/settings/add-property-type-set-option' || Route::current()->uri() == 'admin/settings/edit-property-type-set-option/{id}') ? 'active' : ''  }}">
					<a href="{{ url('admin/settings/property-type-set-option') }}" data-group="ware-house-type">Property Type Option Set</a>
				</li>
			@endif
			@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'floor_type_setting'))
				<li class="{{ (Route::current()->uri() == 'admin/settings/floor-type' || Route::current()->uri() == 'admin/settings/add-floor-type' || Route::current()->uri() == 'admin/settings/edit-floor-type/{id}') ? 'active' : ''  }}">
					<a href="{{ url('admin/settings/floor-type') }}" data-group="floor-type">Floor Type</a>
				</li>
			@endif
            ...
            @if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'social_logins'))
                 <li class="{{ (Route::current()->uri() == 'admin/settings/social-logins') ? 'active' : ''  }}">
                     <a href="{{ url('admin/settings/social-logins') }}"  data-group="social_logins">Social Logins</a>
                 </li>
            @endif
