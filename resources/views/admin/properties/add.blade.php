                        ...
                        <form id="add_pr" class="form-horizontal" method="post"
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group row mt-2">
                                    <label for="exampleInputEmail1" class="control-label col-sm-3 mt-2 fw-bold">User <span
                                ...
                                <div class="form-group row mt-3">
                                    <label for="exampleInputEmail1" class="control-label col-sm-3 mt-2 fw-bold">Home
                                        Type</label>
                                    <div class="col-sm-6">
                                        <select name="property_type_id" class="form-control f-14" id="toggleSelect">
                                ...
                                <div class="form-group row mt-3 container">
                                    {{-- commit by ankit 06/12/2024 --}}
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row mt-3" id="accommodates">
    ...
    <script>
        $(document).ready(function() {
            ...
            function addDiv(label, name, options) {
                var formGroup = $("<div>").addClass("form-group row mt-3 container");
                var labelElement = $("<label>").attr("for", "exampleInputEmail1").addClass(
                    "control-label col-sm-3 mt-2 fw-bold").text(label);
                var selectDiv = $("<div>").addClass("col-sm-6");
                var select = $("<select>").attr("name", name).addClass("form-control f-14");

                $.each(options, function(key, value) {
                    select.append($("<option>").attr("value", key).text(value));
                });
                selectDiv.append(select);
                formGroup.append(labelElement).append(selectDiv);
                $(".container").append(formGroup);
            }
            var space_type_options = {!! json_encode($space_type) !!};
            addDiv('Room Type', 'space_type', space_type_options);
        });
    </script>
@endsection
