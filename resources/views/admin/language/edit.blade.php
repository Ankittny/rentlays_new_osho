                ...
                <div class="col-lg-9 col-12">
                    <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Language Form</h3><span class="email_status" >(<span class="text-green"><i class="fa fa-check" aria-hidden="true"></i>Verified</span>)</span>
                        </div>

                        <form id="edit_language" method="post" action="{{ url('admin/settings/edit-language/' . $result->id ) }}" class="form-horizontal">
                            {{ csrf_field() }}
                            <div class="box-body">
                            ...
                            <div class="box-footer">
                                ...
                                <a class="btn btn-danger f-14" href="{{ url('admin/settings/banners') }}">Cancel</a>
