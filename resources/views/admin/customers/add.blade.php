            ...
            <div class="box">
                <form class="form-horizontal" action="{{ url('admin/add-customer') }}" id="add_customer" method="post" name="add_customer" accept-charset='UTF-8'>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group mt-3 row">
                            <label for="exampleInputPassword1" class="control-label col-sm-3 mt-2 fw-bold">Country<span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                                <select class="form-control" name="country">
                                   @if($country->count()>0)
                                    @foreach($country as $items) 
                                    <option value="{{$items->name}}">{{ucfirst($items->name)}}</option>
                                    @endforeach
                                   @endif
                                </select>
                                {{-- <input type="text" class="form-control error" name="email" id="email" placeholder=""> --}}
