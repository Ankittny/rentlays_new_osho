    ...
    <section class="content">
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="{{ url('admin/add-vendor-master') }}" id="add_vendor_master" method="post" name="add_vendor_master" accept-charset='UTF-8' enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="box-body">
                ...
                <div class="box-footer">
                  ...
                  <a class="btn btn-danger f-14" href="{{ url('admin/vendor_master') }}">Cancel</a>
                </div>
                <!-- /.box-footer -->
            </form>
          </div>
