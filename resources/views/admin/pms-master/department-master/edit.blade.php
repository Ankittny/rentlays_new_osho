            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="{{ url('admin/edit-department-master/' . $result->id) }}"
                            id="edit_department_master" method="post" name="edit_department_master" accept-charset='UTF-8'
                            ...
                            <div class="box-footer">
                                ...
                                <a class="btn btn-danger f-14" href="{{ url('admin/department-master') }}">Cancel</a>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>
