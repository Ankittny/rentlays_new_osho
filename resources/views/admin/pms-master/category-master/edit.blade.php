            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="{{ url('admin/edit-category-master/' . $result->id) }}"
                            id="edit_brand_master" method="post" name="edit_category_master" accept-charset='UTF-8'
