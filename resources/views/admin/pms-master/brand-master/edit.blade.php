            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="{{ url('admin/edit-brand-master/' . $result->id) }}"
                            id="edit_brand_master" method="post" name="edit_brand_master" accept-charset='UTF-8'
                            ...
                            <div class="box-footer">
                                ...
                                <a class="btn btn-danger f-14" href="{{ url('admin/brand-master') }}">Cancel</a>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>
