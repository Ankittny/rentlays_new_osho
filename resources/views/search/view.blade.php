...
<style>
    ...
    @media (max-width:767px) {
        ...
        .list-inline-item .dropdown-menu-location {
    ...
    @media(max-width:676px) and (min-width:426px) {
        .list-inline-item .dropdown-menu-location {
            position: inherit !important;
            transform: none !important;
            width: 40rem !important;
...
@endpush
@section('main')
<div class="container-fluid container-fluid-90 bg-white main-panel border-0 p-0 mt-50">
    <div class="row">
        <!-- Filter section start-->
        <div class="col-md-12  hidden-pod filter-h" id="listCol">
            <div class="row mt-4">
                    ...
                    <ul class="list-inline  pl-4">
                        <li class="list-inline-item mt-4">
                            <div class="dropdown">
                                ...
                                <div class="w-100">
                                    <div class="dropdown-menu dropdown-menu-location show-off-vx" aria-labelledby="dropdownMenuButton">
                                        <div class="row p-3">
                                ...
                                <div class="row p-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex justify-content-between pr-4">
                                            ...
                                            <div>
                                                <input type="checkbox" id="space_type_{{ $rws }}" name="property_type[]" value="{{ $rws }}" class="form-check-input" {{ in_array($rws, $property_type_selected) ? 'checked' : '' }}>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
        ...
        <!--Map section start -->
        <div class="col-md-5 p-0 d-none" id="mapCol">
    ...
    <!-- Modal -->
    <div class="modal fade mt-5 z-index-high" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="overflow-x:hidden">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg " role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-filter">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="collapse" id="amenities-collapse" style="margin:0px 16px">
                                <div class="row">
                ...
                <div class="row mt-5">
                    <div class="col-sm-12">
                        <h5 class="font-weight-700 text-24 pl-4" for="user_birthdate">{{ __('Property Type') }}</h5>
                    </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="collapse" id="property-collapse" style="margin:0px 16px">
                            <div class="row">
        ...
        <div class="modal-footer p-4">
            <button class="btn btn-outline-danger text-16 pl-3 pr-3 mr-4" data-dismiss="modal">{{ __('Cancel') }}</button>
            <button class="btn vbtn-outline-success filter-apply text-16 mr-5 pl-3 pr-3 ml-2" data-dismiss="modal">{{ __('Apply Filter') }}</button>
        </div>
    </div>
</div>
</div>
