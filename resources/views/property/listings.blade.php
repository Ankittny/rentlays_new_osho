                                ...
                                <div class=" row  border p-2 rounded-3">
                                    ...
                                    <div class="col-md-6 col-xl-6 p-2">
                                        ...
                                        <ul class="list-inline mt-2 pb-3">
                                            <li class="list-inline-item border rounded-3 p-1 mt-4 pl-3 pr-3">
                                                <p class="text-center mb-0">
                                                    <i class="fa fa-home fa-2x text-20 d-none d-sm-inline-block text-muted"></i>
                                                    {{ $property->space_type_name }}
                                                    {{-- <span class=" text-14 font-weight-700">{{ __('Property Type') }}</span> --}}
                                                </p>
                                            </li>
                                            <li class="list-inline-item  border rounded-3 mt-4 p-1  pl-3 pr-3">
                                                <p  class="text-center mb-0" >
                                                    <i class="fa fa-building fa-2xs d-none d-sm-inline-block text-20 text-muted"></i>
                                                    {{ $property->floor }}
                                                    <span class=" text-14 font-weight-700">{{ __('Floor') }}</span>
                                                </p>
                                            </li>
                                            <li class="list-inline-item  border rounded-3 mt-4 p-1  pl-3 pr-3">
                                                <p  class="text-center mb-0">
                                                    <i class="fas fa-bath text-20  d-none d-sm-inline-block  text-muted"></i>
                                                    {{ $property->super_area }}
                                                    <span class="text-14 font-weight-700">{{ __('Sq Fit') }}</span>
                                                </p>
                                            </li>
                                        </ul>
                                                        ...
                                                        <div class="main-toggle-switch text-left text-sm-center">
                                                            @if ($property->steps_completed == 0)
                                                                ...
                                                                @else
                                                                    ...
                                                                    @php
                                                                        $PmsOnboard = App\Models\PmsOnboard::where('property_id',$property->id)->first();
                                                                    @endphp
                                                                    @if(!empty($PmsOnboard) && $PmsOnboard->status=="0")
                                                                     <Button class="btn btn-warning btn-xl">Pending Verification For PMS</button>
                                                                   @else
                                                                   <a href="{{url('subcribe').'/'.$property->slug}}" class="btn btn-danger btn-xl">Subcribe</a>
                                                                   @endif
                                                                @endif
                                                            @else
