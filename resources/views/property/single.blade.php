...
@elseif ($i <= 4) @if ($i==4) <div class="p-2 position-relative">
    ...
    <div class="col-lg-4 col-xl-4 mb-4 mt-4">
        <div id="sticky-anchor" class="d-none d-md-block"></div>
        <div class="card" style="position: sticky;  top: 96px;  height:auto">
    ...
    @elseif ($i <= 4) @if ($i==4) <div class="p-2 position-relative">
        ...
        <div class="mapping-area mt-5">
            <div class="container-fluid">
                <div class="map-location ">Location</div>
                <div class="row">
                    <div class="col-lg-9">
                        <div class="searching-map">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d28030.381186029583!2d77.320955!3d28.57583845!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1738323843706!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="accordian-graph">

                            <div id="accordion" class="accordion">
                                <div class="card mb-0">
                                    <div class="card-header collapsed" data-toggle="collapse" href="#collapseOne">
                                        <a class="card-title">
                                            <i class='fas fa-map-marker-alt'></i> Key Landmarks
                                        </a>
                                    </div>
                                    <div id="collapseOne" class="card-body collapse" data-parent="#accordion">
                                        <div class="radio-bbtn d-flex justify-content-around">
                                            <label class="">
                                                <input type="checkbox">
                                                <span class="checkmark"></span>
                                            </label>
                                            <div class="img-set"><img src="http://localhost/rentlays_new_osho/public/images/property/94/m_activities_colombo_gangaramaya_temple 4.59.55 PM_l_400_640.avif" class="room-image-container200" alt="img11"></div>
                                            <div class="all-tea-garden">
                                                <p>Tea Gardens</p>
                                                <span>Tourist Attraction</span>
                                            </div>
                                            <div class="location-find text-end">
                                    ...
                                    <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                        <a class="card-title">
                                            <i class='fas fa-map-marker-alt'></i> Transport
                                        </a>
                                    </div>
                                    ...
                                    <div id="collapseThree" class="collapse mt-3" data-parent="#accordion">
                                        <div class="radio-bbtn d-flex justify-content-around">
                                            <label class="">
                                                <input type="checkbox">
                                                <span class="checkmark"></span>
    ...
    <div id="ninja-slider">
        ...
        <script type="text/javascript">
            ...
            function initMap() {
                ...
                const categories = [{
                        name: 'School/College',
                        keywords: 'school OR college'
                    },
                    {
                        name: 'Hospital/Clinic',
                        keywords: 'hospital OR clinic'
                    },
                    {
                        name: 'Public Transport',
                        keywords: 'bus stop OR metro station'
                    },
                    {
                        name: 'Restaurants/Cafes',
                        keywords: 'restaurant OR cafe'
                    },
                    {
                        name: 'Supermarket',
                    ...
                    },
                    {
                        ...
                        keywords: 'walking track OR jogging track'
                    },
                    {
                        name: 'Sports Complex',
                        keywords: 'sports complex'
                    },
                    {
