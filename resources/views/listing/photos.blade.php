				...
				<div class="col-md-10  dashboardbkground">
					<div class="main-panel min-height mt-4 ">
						<div class="row justify-content-center">
							<div class="col-md-3 pl-4 pr-4  bkwhite">
										...
										<div class="col-md-12 border mt-4 pb-5 rounded-3 pl-sm-0 pr-sm-0 ">
											<div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-9">
                                                                    <input class="form-control text-16" name="file" id="photo_file"
                                                                           type="file" value="" accept="image/*" multiple>
                                                                    ...
                                                                    <p class="text-13">(3333Width 640px and Height 360px)
                                                                    </p>
                                                    ...
                                                    <div class="row">
                                                        <div id="photo-list-div" class="col-md-12 p-0 mm">
                                                            <?php
                                                            $serial = 0;
                                                            ?>
                                                            <div class="row">
